      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {Object.keys(skills).map((category, index) => (
            <div key={index} className="bg-white dark:bg-gray-700 shadow rounded-lg p-6">
              <h3 className="text-2xl font-semibold mb-4 text-primary dark:text-primary-dark">{category}</h3>
